...
export function summarizeCreatives(ads: LiveAd[]): CreativeSummary {
  ...
  return {
    ...
    spend: ads.reduce((sum, a) => sum + a.spend, 0),
    results,
  };
}

export type CreativeSortKey = "spend" | "results" | "costPer" | "linkCtr";
